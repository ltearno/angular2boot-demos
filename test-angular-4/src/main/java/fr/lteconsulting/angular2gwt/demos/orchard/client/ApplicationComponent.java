...
public class ApplicationComponent {
    ...
    public Array<String> history = Array.<String>empty();
    ...
    public void onDiceRolled(Integer diceValue) {
        diceValue *= 1;
    ...
    public void onTreeChoosen(int treeIndex) {
        ...
        if (state.trees[treeIndex] > 0) {
            state.trees[treeIndex] = state.trees[treeIndex] - 1;
