...
import static fr.lteconsulting.jsinterop.ng.platformBrowserDynamic.GlobalScope_NgPlatformBrowserDynamic.platformBrowserDynamic;
...
public class Application implements EntryPoint
{
	...
	public void onModuleLoad()
	{
		 ...
		 */
		platformBrowserDynamic().bootstrapModule( ApplicationModule_AngularModule.getNgModulePrototype() );
	}
}